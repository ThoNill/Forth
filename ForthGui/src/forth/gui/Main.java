...
public class Main extends Application {
    ...
    private TitledPane createExamples() {
        ...
        for (Example example : Example.values()) {
            vbox.getChildren().add(
                    createButton(example.getDescription(), new ExamplesHandler(
                            this, example)));
        }
    ...
    private void setStatus(Status status) {
        ...
        case INIT:
            textInitialisieren();
            programmText
                    .setText(" : HalloWelt! \" Hallo Welt!\" TYPE ; HalloWelt! ");
            break;
        case START:
            abarbeitungStarten();
            break;
    ...
    private void abarbeitungStarten() {
        tokenStream = new TokenStreamWithPosition(programmText.getText());
    ...
    protected void oberflächeAktualisieren() {
        ...
        ListConverter.update(programmStackView, forth.getProgrammStack(),
                new DictionaryConverter(forth.getDictionary()));
